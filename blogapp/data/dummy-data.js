...
async function populate() {
    ...
    if(count == 0) { 
        ...
        const users = await User.bulkCreate([
            {fullname: "sadık turan", email: "info@sadikturan.com", password: await bcrypt.hash("123456", 10)},
            {fullname: "çınar turan", email: "info@cinarturan.com", password: await bcrypt.hash("123456", 10)},
            {fullname: "ada bilgi", email: "info@adabilgi.com", password: await bcrypt.hash("123456", 10)},
            {fullname: "yiğit bilgi", email: "info@yigitbilgi.com", password: await bcrypt.hash("123456", 10)},
            {fullname: "ahmet yılmaz", email: "info@ahmetyilmaz.com", password: await bcrypt.hash("123456", 10)},
        ]);

        const roles=await Role.bulkCreate([
            {rolename:"admin"},{rolename:"moderator"},{rolename:"guest"}
        ]);
